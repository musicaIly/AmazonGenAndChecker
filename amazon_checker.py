...
init(convert=True)
ctypes.windll.kernel32.SetConsoleTitleW("Amazon Gen and Checker by IQBooster")
text = '''
                  ,---.                                               ,----.                   
                 /  O  \ ,--,--,--. ,--,--.,-----. ,---. ,--,--,     '  .-./    ,---. ,--,--,  
                |  .-.  ||        |' ,-.  |`-.  / | .-. ||      \    |  | .---.| .-. :|      \ 
...
if option == '2':
        ...
        def checker():
                ...
                if success_keyword in r.text:
                        ...
                        save(giftcard[num])
                        ctypes.windll.kernel32.SetConsoleTitleW("Amazon Checker | Checked: " + str(num) + "/" + str(len(giftcards)) + " | Valid: " + str(valid) + " | Invalid: " + str(invalid) + " | Developed by IQBooster")
                else:
